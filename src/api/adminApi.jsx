...
export const fetchCardData = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/cardData.php'); // Fetch the file with title and total
    return response.data;
  } catch (error) {
...
export const fetchLineChartData = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/lineChartData.php'); 
    return response.data;
  } catch (error) {
...
export const fetchBarChartData = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/barChartData.php'); 
    return response.data;
  } catch (error) {
...
export const fetchPieChartPendingData = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/pieChartPendingData.php'); 
    return response.data;
  } catch (error) {
...
export const fetchPieChartPastData = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/pieChartPastData.php'); 
    return response.data;
  } catch (error) {
...
export const fetchProductTableData = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/productTableData.php'); 
    return response.data;
  } catch (error) {
...
export const fetchCategoryOptions = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/categoryTableData.php'); 
    return response.data;
  } catch (error) {
...
export const fetchScentOptions = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/scentsTableData.php'); 
    return response.data;
  } catch (error) {
...
export const deleteProduct = async (productId) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/deleteProduct.php', productId );
...
export const fetchOrdersTableData = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/ordersTableData.php'); 
    return response.data;
  } catch (error) {
...
export const postOrderStatus = async (newOrderStatus) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/updateStatus.php', newOrderStatus); 
    return response.data;
  } catch (error) {
...
export const fetchClientsTableData = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/clientsTableData.php'); 
    return response.data;
  } catch (error) {
...
export const postClientDelete = async (clientId) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/deleteClient.php', clientId); 
    return response.data;
  } catch (error) {
...
export const postScentUpdates = async (updatedScent) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/updateScent.php', updatedScent);
    return response.data;
  } catch (error) {
...
export const addScent = async (newScent) => {
  try {
    const response = await fetch('https://blushe.shop/backend/admin/addScent.php', {
      method: 'POST',
      headers: {
...
export const deleteScent = async (scentId) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/deleteScent.php', scentId );
    return response.data; // Handle success response (optional)
  } catch (error) {
...
export const fetchCouponsTableData = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/couponsTableData.php'); 
    return response.data;
  } catch (error) {
...
export const postCouponUpdates = async (updatedCoupon) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/updateCoupon.php', updatedCoupon);
    return response.data;
  } catch (error) {
...
export const addCoupon = async (newCoupon) => {
  try {
    const response = await fetch('https://blushe.shop/backend/admin/addCoupon.php', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
export const deleteCoupon = async (couponId) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/deleteCoupon.php', couponId );
    return response.data; // Handle success response (optional)
  } catch (error) {
...
export const postCategoryUpdates = async (newdata) => {
  try {
    ...
    const response = await axios.post('https://blushe.shop/backend/admin/updateCategory.php', formData, {
      headers: {
...
export const addCategory = async (newdata) => {
  try {
    ...
    // Send the request with the FormData
    const response = await axios.post('https://blushe.shop/backend/admin/addCategory.php', formData, {
      headers: {
        'Content-Type': 'multipart/form-data', // Ensure the request is treated as a file upload
      },
    });
...
export const deleteCategory = async (categoryId) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/deleteCategory.php', categoryId );
    return response.data; 
  } catch (error) {
...
export const fetchDiscountSettings = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/discountSettings.php'); // Replace with actual API URL
...
export const postDiscountSettings = async (settings) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/updateDiscountSettings.php', settings); // Replace with actual API URL
    return response.data;
  } catch (error) {
...
export const fetchCarouselData = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/carouselData.php');
    return response.data;
  } catch (error) {
...
export const fetchProducts = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/admin/productsData.php'); // Assuming this returns product list with id and name
    return response.data;
  } catch (error) {
...
export const saveCarouselData = async (carousels) => {
  try {
    ...
    const response = await axios.post('https://blushe.shop/backend/admin/addCarousel.php', formData, {
      headers: {
...
export const fetchOrderSummaryData = async (orderId) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/orderSummary.php', orderId);
    return response.data;
  } catch (error) {
...
export const fetchProductData = async (productId) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/productDetails.php',productId);  // Adjust the path based on your project setup
...
export const updateProductData = async (product, productId,currentScentId,removedImages) => {
  try {
      ...
      const response = await axios.post('https://blushe.shop/backend/admin/updateProduct.php', formData, {
...
export const postProductData = async (product) => {
  try {
      ...
      const response = await axios.post('https://blushe.shop/backend/admin/addProduct.php', formData, {
          headers: {
              'Content-Type': 'multipart/form-data',
          },
      });
...
export const postRemoveScent = async (scentId, productId) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/deleteScentProduct.php', {
      scentId: scentId,
      productId: productId,
    });
    return response.data;
...
export const applyDiscountToProducts = async (discountValue, productIds) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/bulkDiscount.php', {
...
export const fetchReviewsTableData = async (productId) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/Reviews.php',productId); 
    return response.data;
  } catch (error) {
...
export const postReviewDelete = async (reviewId) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/admin/deleteReview.php', reviewId); 
    return response.data;
  } catch (error) {
