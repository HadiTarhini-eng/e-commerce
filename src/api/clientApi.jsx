...
export const fetchCarouselData = async () => {
    const carouselResponse = await axios.get('https://blushe.shop/backend/client/carousel.php');
...
export const fetchCategoriesData = async (page) => {
    ...
    if (page === 'Home') {
        url = 'https://blushe.shop/backend/client/categoryData.php';
    } else if (page === 'Payment') {
        url = 'https://blushe.shop/backend/client/paymentTypeData.php';
    }
...
export const fetchProductsData = async (userId) => {
    const response = await axios.get('https://blushe.shop/backend/client/productCardData.php', {
      params: { userId }
...
export const fetchOrderDetailsById = async (orderID) => {
  try {
    const response = await axios.get('https://blushe.shop/backend/client/orderDetails.php',{
      params: { orderID }
    });
...
export const fetchOrderHistory = async (userId) => {
  try {
    const response = await axios.get('https://blushe.shop/backend/client/orders.php', {
      params: { userId }
    });
...
export const fetchOrderTrackById = async (orderID) => {
  try {
    const response = await axios.get('https://blushe.shop/backend/client/orderHistory.php',{
      params: { orderID }
    });
    const order = response.data.find(order => order.orderID === orderID);
...
export const fetchDeliveryThreshold = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/client/deliveryThreshold.php');
...
export const fetchUserDetails = async (userId) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/client/userData.php', {
      userId
    });
...
export const submitOrder = async (payload) => {// Debugging: check the payload
  try {
    const response = await axios.post('https://blushe.shop/backend/client/submitOrder.php', payload);
    if (response.status !== 200) {
...
export const postSignInData = async (credentials) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/client/signIn.php', credentials);
...
export const postSignUpData = async (userData) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/client/signUp.php', userData); //edit this as you like
    if (response.status !== 200) {
...
export const toggleFavoriteStatus = async (userId, productId, favoriteStatus) => {
  try {
    const response = await axios.post('https://blushe.shop/backend/client/favoriteStatus.php', {
...
export const submitReview = async (productId, reviewData) => {
  try {
    ...
    const response = await axios.post('https://blushe.shop/backend/client/submitReview.php', {
      productId,
...
export const fetchOrderNumber = async (userId) => {
  const response = await axios.get('https://blushe.shop/backend/client/nbOfOrders.php', {
    params: { userId }
  });
...
export const fetchFirstOrderOffer = async () => {
  try {
    const response = await axios.get('https://blushe.shop/backend/client/firstOffer.php');
...
export const fetchCouponValue = async (couponInput) => {
  const response = await axios.get('https://blushe.shop/backend/client/fetchCouponValue.php', {
    params: { couponInput }
  });
