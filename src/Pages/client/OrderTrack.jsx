            ...
            <div className="space-y-6 rounded-lg border border-gray-200 bg-white p-6 px py-2 shadow-sm dark:border-gray-700 dark:bg-gray-800">
              ...
              <div className="gap-4 sm:flex sm:items-center">
                <a
                  ...
                  className="mt-4 flex w-full items-center justify-center rounded-lg bg-palette-button px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:mt-0"
                >
                  Order Details
                </a>
              </div>
