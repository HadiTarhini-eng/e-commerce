        ...
        <div className="w-full max-w-7xl px-1 md:px-5 lg-6 mx-auto">
                  ...
                  <div className="flex items-center flex-row gap-2 w-full max-xl:max-w-xl max-xl:mx-auto">
                    ...
                    <div className="flex flex-col items-center w-full max-w-[200px] sm:max-w-[220px]">
                      ...
                      <h6 className="text-palette-button font-manrope font-bold text-base sm:text-2xl leading-9 w-full max-w-[176px] text-center">
                        ${parseFloat(product.newPrice * product.quantity).toFixed(1)}
                      </h6>
                      {/* Remove Item Button */}
          ...
          <div className="bg-white rounded-xl mt-6 p-4 sm:p-6 w-full mb-2 max-lg:max-w-xl max-lg:mx-auto sticky bottom-0 left-0 z-1">
            <div className="flex items-center justify-between w-full py-4 sm:py-6">
              ...
              {orderNumber === 0 ? (
                <>
                  ${parseFloat(totalWithoutDelivery.newPrice).toFixed(1)}
                  <span className="line-through text-gray-500 text-lg font-['Roboto'] mx-1">
                    ${parseFloat(totalWithoutDelivery.originalPrice).toFixed(1)}
                  </span>
                </>
              ) : (
                <>
                  ${parseFloat(totalWithoutDelivery).toFixed(1)}
                </>
              )}
              </h6>
            </div>
