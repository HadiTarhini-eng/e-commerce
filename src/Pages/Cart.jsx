    ...
    <div className="min-h-screen flex flex-col items-center w-full">
      ...
      <div className="w-full max-w-lg px-4 mt-4">
        ...
        <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
            ...
            {/* Fixed Total Summary */}
            <div className="bg-gray-50 rounded-xl p-4 sm:p-6 w-full mb-8 max-lg:max-w-xl max-lg:mx-auto sticky bottom-0 left-0 z-10">
            ...
            <button className="rounded-full w-full max-w-[240px] py-3 sm:py-4 text-center justify-center items-center bg-indigo-600 font-semibold text-sm sm:text-lg text-white flex transition-all duration-500 hover:bg-indigo-700">
                Continue to Payment
