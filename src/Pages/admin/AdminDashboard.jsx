...
import { fetchCardData, fetchLineChartData, fetchBarChartData } from '../../api/adminApi';
...
import ChartOne from '../../components/admin/dashboard/ChartOne';
import ChartTwo from '../../components/admin/dashboard/ChartTwo';
import ChartThree from '../../components/admin/dashboard/ChartThree';
  ...
  useEffect(() => {
    const fetchCard = async () => {
      try {
        ...
        setBarChartData(barChartResponse.dataSource);
      } catch (error) {
